...
use app\models\SliderGambar;
    use app\models\search\SliderGambarSearch;
...
/**
* SliderGambarController implements the CRUD actions for SliderGambar model.
*/
...
/**
* Lists all SliderGambar models.
* @return mixed
*/
public function actionIndex()
{
    $searchModel  = new SliderGambarSearch;
...
$path = Yii::getAlias("@app/web/uploads/slider-gambar/") . $file;
$arr = explode(".", $file);
$extension = end($arr);
...
/**
* Displays a single SliderGambar model.
* @param integer $id
*
* @return mixed
*/
...
/**
* Creates a new SliderGambar model.
* If creation is successful, the browser will be redirected to the 'view' page.
* @return mixed
*/
public function actionCreate()
{
$model = new SliderGambar;
...
if ($model->load($_POST)) {
    $gambars = UploadedFile::getInstance($model, 'gambar');
        if($gambars !=NULL){
                    ...
                    if(file_exists(Yii::getAlias("@app/web/uploads/slider-gambar/")) == false){
                        mkdir(Yii::getAlias("@app/web/uploads/slider-gambar/"), 0777, true);
                    }
                    $path = Yii::getAlias("@app/web/uploads/slider-gambar/") . $model->gambar;
        $gambars->saveAs($path);
                }
if($model->save()){
...
/**
* Updates an existing SliderGambar model.
    ...
    $gambars = UploadedFile::getInstance($model, 'gambar');
            if ($gambars != NULL) {
                ...
                if($oldGambar != NULL){
                    ...
                    $gambars->saveAs($path);
                    unlink(Yii::$app->basePath . '/web/uploads/slider-gambar/' . $oldGambar);
                }else{
                    $gambars->saveAs($path);
                }
            }else{
...
/**
* Deletes an existing SliderGambar model.
...
/**
* Finds the SliderGambar model based on its primary key value.
* If the model is not found, a 404 HTTP exception will be thrown.
* @param integer $id
* @return SliderGambar the loaded model
* @throws HttpException if the model cannot be found
*/
protected function findModel($id)
{
if (($model = SliderGambar::findOne($id)) !== null) {
return $model;
} else {
